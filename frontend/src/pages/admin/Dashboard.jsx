...
import { Users, UserCheck, Calendar, Bell, Activity, UserPlus, ShieldAlert, ArrowRight } from 'lucide-react';
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--bg-base)' }}>
      ...
      <main style={{ flex: 1, padding: 40, maxWidth: 1200 }}>
        ...
        <p style={{ color: 'var(--text-secondary)', fontSize: 14, marginBottom: 32 }}>System overview, doctor onboarding, registrations, and notification delivery monitoring.</p>
              ...
              <Link to="/admin/doctors" style={{ textDecoration: 'none' }}>
                <motion.div whileHover={{ y: -4 }} className="glass-card" style={{ padding: 24, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                  <div>
                    ...
                    <h3 style={{ fontSize: 18, color: 'var(--text-primary)', marginBottom: 6 }}>Register / Onboard Doctor</h3>
                    <p style={{ fontSize: 13, color: 'var(--text-secondary)' }}>Directly register and activate new doctor profiles without self-registration review.</p>
                  </div>
