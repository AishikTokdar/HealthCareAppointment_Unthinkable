...
import { Users, Calendar, Plus, User, Trash2, UserPlus, CheckCircle } from 'lucide-react';
      ...
      <main style={{ flex: 1, padding: 40, maxWidth: 1100 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 32 }}>
          <div>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: 14 }}>Register new clinic doctors, schedule leave, and manage profiles.</p>
          </div>
          <button
        ...
        {/* Modal for Direct Doctor Registration */}
